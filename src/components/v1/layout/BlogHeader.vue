  ...
  >
    <nav class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
      <div class="flex items-center gap-2 sm:gap-4 h-14 sm:h-16">
        ...
        >
          <div
            class="w-7 h-7 sm:w-9 sm:h-9 rounded-lg flex items-center justify-center bg-blue-600"
          >
            <font-awesome-icon
              icon="book"
        ...
        <!-- Desktop Nav Panel -->
        <div
          class="hidden md:flex items-center gap-1 px-2 py-1.5 rounded-lg transition-all"
          :class="
            isDark
        ...
        <div class="flex items-center gap-1 sm:gap-2">
          <!-- Search Button -->
          <button
            class="p-1.5 sm:p-2 rounded-lg transition-all cursor-pointer"
            :class="
              isDark
          ...
          >
            ...
            <span
              ...
              class="absolute top-1.5 right-1.5 w-2 h-2 bg-red-500 rounded-full ring-2"
          ...
          <div class="relative" ref="userMenuRef">
            ...
            <transition>
              <div
                v-if="isUserMenuOpen"
                class="absolute right-0 mt-4 w-60 sm:w-64 rounded-xl overflow-hidden z-50"
                :class="
                  isDark
